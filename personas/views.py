...
from personas.models import Libro, Categoria, Presentacion

from personas.serializers import LibroSerializer, PresentacionSerializer, CategoriaSerializer
...
class LibroViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = Libro.objects.all().order_by('-autor')
